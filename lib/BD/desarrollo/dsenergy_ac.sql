...
MySQL - 5.1.41 : Database - dsenergy_ac
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dsenergy_ac` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
LOCK TABLES `cf_actividad` WRITE;
...
LOCK TABLES `cf_entregable` WRITE;
...
LOCK TABLES `cf_subactividad` WRITE;
...
LOCK TABLES `cf_tipobaremo` WRITE;
...
LOCK TABLES `dt_detalle_presupuesto` WRITE;
...
LOCK TABLES `dt_subestacion` WRITE;
...
LOCK TABLES `pt_alcance_subactividad` WRITE;
...
LOCK TABLES `pt_baremo_actividad` WRITE;
...
LOCK TABLES `pt_descargo` WRITE;

insert  into `pt_descargo`(`descargo_id`,`descargo_actividad`,`descargo_fechacreo`,`descargo_fechamodifico`,`descargo_riesgo`,`descargo_usuariocreo`,`descargo_usuariomodifico`,`ordentrabajo_id`,`presupuesto_id`) values (1,'descargo prueba modificacion','2017-04-17 22:56:58','2017-06-07 15:46:48','sin riesgo cambio','1','1',1,33),(2,'validar actividades de descargo','2017-04-17 22:57:19','2017-06-07 15:44:56','con riesgo VYP','1','1',1,43),(3,'prueba modulo','2017-06-14 18:02:54',NULL,'N/A','1',NULL,2,62);
...
LOCK TABLES `pt_detalle_actividad` WRITE;
...
LOCK TABLES `pt_detalle_factura` WRITE;
...
LOCK TABLES `pt_detalle_subactividad` WRITE;
...
LOCK TABLES `pt_entregable_subactividad` WRITE;
...
LOCK TABLES `pt_menu_perfil` WRITE;
...
LOCK TABLES `pt_orden_trabajo` WRITE;
...
LOCK TABLES `pt_perfil_usuario` WRITE;
...
LOCK TABLES `pt_prerfil_usuario` WRITE;
...
LOCK TABLES `pt_presupuesto` WRITE;
...
LOCK TABLES `pt_seguimiento` WRITE;
...
LOCK TABLES `pt_soporte_seguimiento` WRITE;
