...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`energy_ac` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_spanish_ci */;
...
if _tipoControl='1' THEN -- Consultar
		...
		*/
		...
		INNER JOIN pt_seguimiento sg ON ps.presupuesto_id=sg.presupuesto_id
			   AND sg.seguimiento_id =(SELECT seguimiento_id FROM pt_seguimiento where presupuesto_id=ps.presupuesto_id order by seguimiento_id desc limit 1)
			   AND sg.seguimiento_estado=1
			   AND sg.seguimiento_fechafin  BETWEEN _factura_fechainicio AND _factura_fechafin
              JOIN dt_subestacion sb ON dp.subestacion_id=sb.subestacion_id
