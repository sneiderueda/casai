...
MySQL - 5.5.32 : Database - energy_ac
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`energy_ac` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */;
...
IN _detallepresupuesto_valorincremento varchar(1000)
)
BEGIN
                    ...
                    BAREMO_ACTIVIDAD:BEGIN
                        ...
                        OPEN CR_BAREMO_ACTIVIDAD;
							Loop_baremo_actividades:LOOP
                                ...
                                FETCH CR_BAREMO_ACTIVIDAD INTO _baremoactividad_id,_baremo_id;
								IF _rowsbaremoactividades THEN
									 LEAVE Loop_baremo_actividades;
								END IF;
                                
                                -- validar si existe el baremo
                                SELECT baremo_item FROM pt_baremo WHERE baremo_id=_baremo_id
                                INTO _baremo_item;
                                
                                SELECT baremo_id FROM pt_baremo where baremo_item=_baremo_item AND contrato_id=_contrato_new
                                INTO _existe_baremo;
...
DECLARE tecnicopresupuesto_id INT;
...
ELSEIF _tipoControl='16' THEN -- INSERTAR INGENIEROS DE LA CUMPLIMENTACION
            ...
            IF _existe_presupuesto ="" THEN 
				...
				SET tecnicopresupuesto_id= LAST_INSERT_ID();
			END IF;
ELSEIF _tipoControl='17' THEN -- ELIMINAR TECNICOS DEL PRESUPUESTO
DELETE  FROM cf_tecnico_presupuesto WHERE presupuesto_id=_presupuesto_id;
...
if _tipoControl='1' THEN -- Consultar 
		 SELECT sg.*,
           ...
           JOIN dt_usuario usu ON sg.seguimiento_usuariocreo=usu.usuario_id
