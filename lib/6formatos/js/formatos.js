...
function DescargarPresupuestoWordInterna(detalle_presupuesto) {

    location.href = 'lib/6formatos/view/wordOtInterna.php?er=' + detalle_presupuesto;
}

function descargar_xlxs_conformidad(num_conformidad) {

    location.href = 'lib/6formatos/view/excel_conformidad.php?er=' + num_conformidad;
}
