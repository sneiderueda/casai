...
//ALINEAR TEXTO
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A3:I5')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getStyle('A3:I5')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
...
//Conbinar celdas
    ...
    $objPHPExcel->getActiveSheet()->mergeCells('A3:I5');
...
//TIPO DE LETRA
    ...
    $objPHPExcel->getActiveSheet()->getStyle('A3')->getAlignment()->setVertical(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    ...
    $objPHPExcel->getActiveSheet()->getStyle('J6:O6')->getFont()->setName('Calibri');
    $objPHPExcel->getActiveSheet()->getStyle('J6:O6')->getFont()->setSize(9);
    $objPHPExcel->getActiveSheet()->getStyle('J6:O6')->getFont()->setBold(true);
    $objPHPExcel->getActiveSheet()->getStyle('J6:O6')->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('J6:O6')->getAlignment()->setVertical(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
//Agregar valores a las celdas
    $encabezado = 'MEDICION PARCIAL DE AVANCE DE OBRA CODENSA SA ESP' . PHP_EOL . 'DEPARTAMENTO DE PROYECTOS DE REDES ALTA TENSIÓN' . PHP_EOL . ''
            ...
            . 'Proyecto: ' . utf8_encode($row['ordentrabajo_obs']) . '' . PHP_EOL . 'Acta N° ' . $new_acta_ot . ': ' . $exp_fecha[2] . '' . PHP_EOL . 'Periodo Facturación: ' . $exp_fecha[2] . '' . PHP_EOL . '' . $row['ordentrabajo_num'] . '' . PHP_EOL;
    ...
    $objPHPExcel->setActiveSheetIndex(1)
            ...
            ->setCellValue('J5', 'valor ejecutado Acta No. ' . $new_acta_ot . ' ' . $exp_fecha[2])
            ->setCellValue('J6', 'Cantidad')
            ->setCellValue('K6', 'Vr. Ejecutado')
            ->setCellValue('L6', '%')
            ->setCellValue('M5', 'Valor acumulado')
            ->setCellValue('M6', 'Cantidad')
            ->setCellValue('N6', 'Vr. Acumulado')
            ->setCellValue('O6', '%');
...
//tipo de relleno, color de fondo y color del texto
    $objPHPExcel->getActiveSheet()->getStyle('J5:O5')->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
    $objPHPExcel->getActiveSheet()->getStyle('J5:O5')->getFill()->getStartColor()->setARGB('FFFF00');
...
//1. CAntidad de Modulos
    ...
    while ($row_mod = $obj_bd->FuncionFetch($resultado_modulo)) {
        ...
        while ($row_act = $obj_bd->FuncionFetch($result_act)) {
            ...
            if ($num_sub > 0) {//Si tiene subactividades (Se pinta)
                while ($row_sub = $obj_bd->FuncionFetch($result_sub)) {
                    ...
                    $objPHPExcel->setActiveSheetIndex(1)->setCellValue('F' . $F, utf8_encode($row_sub['presupuesto_porcentaje']));
                    $objPHPExcel->setActiveSheetIndex(1)->setCellValue('G' . $G, utf8_encode($row_act['actividad_valorservicio']));
                    $objPHPExcel->setActiveSheetIndex(1)->setCellValue('H' . $H, utf8_encode($row_sub['presupuesto_valorporcentaje']));
        ...
        $objPHPExcel->getActiveSheet()->getCell('B' . $B)->setValue(utf8_encode($labor . " " . $row_mod['labor_descripcion'] . " - UNIDAD DE MEDIDA " . $medida));
        ...
        //SUBTOTAL
        $objPHPExcel->setActiveSheetIndex(1)->mergeCells('C' . $A_com . ':E' . $A_com);
        ...
        //TOTAL ACTIVIDAD
        $objPHPExcel->setActiveSheetIndex(1)->mergeCells('F' . $A_com . ':H' . $A_com);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('J' . $A_com)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('L' . $A_com)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('K' . $A_com)->getNumberFormat()->setFormatCode('$#,##0.00');
        $objPHPExcel->getActiveSheet()->getStyle('L' . $A_com)->getNumberFormat()->setFormatCode('0.0%;[Red]-0.0%');
        $objPHPExcel->getActiveSheet()->setCellValue('K' . $A_com, '=SUM(K' . $B . ':K' . $sum_agrupada_hasta . ')');
        $objPHPExcel->getActiveSheet()->setCellValue('L' . $A_com, '=SUM(L' . $B . ':L' . $sum_agrupada_hasta . ')');

        //$objPHPExcel->getActiveSheet()->getCell('L' . $A_com)->setValue($porcentaje_facturado . "%");
        $objPHPExcel->getActiveSheet()->getStyle('J' . $A_com . ':O' . $A_com)->getFont()->setBold(true);
        $objPHPExcel->getActiveSheet()->getStyle('J' . $A_com . ':O' . $A_com)->getFill()->setFillType(PHPExcel_Style_Fill::FILL_SOLID);
        $objPHPExcel->getActiveSheet()->getStyle('J' . $A_com . ':O' . $A_com)->getFill()->getStartColor()->setARGB('E26B0A');
        $objPHPExcel->getActiveSheet()->getStyle('J' . $A_com . ':O' . $A_com)->getFont()->getColor()->setARGB(PHPExcel_Style_Color::COLOR_WHITE);
        ...
        $objPHPExcel->getActiveSheet()->getStyle('O' . $A_com)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet()->getStyle('N' . $A_com)->getNumberFormat()->setFormatCode('$#,##0.00');
        $objPHPExcel->getActiveSheet()->getStyle('O' . $A_com)->getNumberFormat()->setFormatCode('0.0%;[Red]-0.0%');
        $objPHPExcel->getActiveSheet()->setCellValue('N' . $A_com, '=SUM(N' . $B . ':N' . $sum_agrupada_hasta . ')');
        $objPHPExcel->getActiveSheet()->setCellValue('O' . $A_com, '=SUM(O' . $B . ':O' . $sum_agrupada_hasta . ')');
        ...
        $objPHPExcel->getActiveSheet()->getCell('O' . $A_com)->setValue($porcentaje_facturado . "%");
...
//total del presupuesto
    ...
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->getCell('H' . $H)->setValue("$" . number_format($subtotal, 0, ',', '.'));

    //RESUMEN A FACTURAR SUBTOTAL

    $objPHPExcel->getActiveSheet()->getStyle('J' . $G)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getCell('J' . $G)->setValue("Subtotal: ");
    ...
    //$objPHPExcel->getActiveSheet()->getCell('K' . $H)->setValue("$" . number_format($subtotal_facturar, 0, ',', '.'));

    $sum_agrupada_hasta = (int) $B_com - 1;
    //$objPHPExcel->getActiveSheet()->getCell('K' . $H)->setValue("$" .$B);
    $objPHPExcel->getActiveSheet()->getStyle('K' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getStyle('L' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getStyle('K' . $H)->getNumberFormat()->setFormatCode('$#,##0.00');
    $objPHPExcel->getActiveSheet()
            ->getStyle('L' . $H)
            ->getNumberFormat()
            ->applyFromArray([
    ...
    // $objPHPExcel->getActiveSheet()->getStyle('L' . $H)->getNumberFormat()->setFormatCode(',000%;[Red]-0.000%');
    $objPHPExcel->getActiveSheet()->setCellValue('K' . $H, '=SUM(K7:K' . $sum_agrupada_hasta . ')/2');

    $objPHPExcel->getActiveSheet()->getStyle('L' . $H)->getFont()->setName('Calibri');
    $objPHPExcel->getActiveSheet()->getStyle('L' . $H)->getFont()->setSize(11);
    $objPHPExcel->getActiveSheet()->getStyle('L' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('L' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->setCellValue('L' . $H, '=(K' . $H . ' /H' . $H . ')');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('N' . $H)->getNumberFormat()->setFormatCode('$#,##0.00');
    $objPHPExcel->getActiveSheet()
            ->getStyle('O' . $H)
            ->getNumberFormat()
            ->applyFromArray([
    ...
    $objPHPExcel->getActiveSheet()->setCellValue('N' . $H, '=SUM(N7:N' . $sum_agrupada_hasta . ')/2');
    //$objPHPExcel->getActiveSheet()->getCell('N' . $H)->setValue("$ " . number_format($subtotal_acumulado, 0, ',', '.'));
    $objPHPExcel->getActiveSheet()->getStyle('O' . $H)->getFont()->setName('Calibri');
    $objPHPExcel->getActiveSheet()->getStyle('O' . $H)->getFont()->setSize(11);
    $objPHPExcel->getActiveSheet()->getStyle('O' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('O' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->setCellValue('O' . $H, '=(N' . $H . ' /H' . $H . ')');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getCell('G' . $G)->setValue("Ubicacion: ");
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->setName('Calibri');
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->setSize(11);
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->setBold(true);
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->getColor()->setARGB('123D05');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->getCell('H' . $H)->setValue("$" . number_format($ubicacion, 0, ',', '.'));


    //RESUMEN A FACTURAR UBICACION A FACTURAR ACTA

    $objPHPExcel->getActiveSheet()->getStyle('J' . $G)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getCell('J' . $G)->setValue("Ubicacion: ");
    $objPHPExcel->getActiveSheet()->getStyle('J' . $G)->getFont()->setName('Calibri');
    $objPHPExcel->getActiveSheet()->getStyle('J' . $G)->getFont()->setSize(11);
    $objPHPExcel->getActiveSheet()->getStyle('J' . $G)->getFont()->setBold(true);
    $objPHPExcel->getActiveSheet()->getStyle('J' . $G)->getFont()->getColor()->setARGB('123D05');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('K' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('K' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->getCell('K' . $H)->setValue("$ " . number_format($cal_ubicacion_fact, 0, ',', '.'));
    ...
    $objPHPExcel->getActiveSheet()->getStyle('M' . $G)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getCell('M' . $G)->setValue("Ubicacion: ");
    $objPHPExcel->getActiveSheet()->getStyle('M' . $G)->getFont()->setName('Calibri');
    $objPHPExcel->getActiveSheet()->getStyle('M' . $G)->getFont()->setSize(11);
    $objPHPExcel->getActiveSheet()->getStyle('M' . $G)->getFont()->setBold(true);
    $objPHPExcel->getActiveSheet()->getStyle('M' . $G)->getFont()->getColor()->setARGB('123D05');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->getCell('H' . $H)->setValue("$" . number_format($subtotal2, 0, ',', '.'));
    ...
    $objPHPExcel->getActiveSheet()->getStyle('K' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('K' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->getCell('K' . $H)->setValue("$" . number_format($subtotal2_facturar, 0, ',', '.'));
    ...
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
    $objPHPExcel->getActiveSheet()->getCell('G' . $G)->setValue("IVA " . $porcentaje . "%: ");
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->setName('Calibri');
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->setSize(11);
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->setBold(true);
    $objPHPExcel->getActiveSheet()->getStyle('G' . $G)->getFont()->getColor()->setARGB('123D05');
    ...
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->getCell('H' . $H)->setValue("$" . number_format($iva, 0, ',', '.'));
    ...
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getFont()->getColor()->setARGB('123D05');
    $objPHPExcel->getActiveSheet()->getStyle('H' . $H)->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_RIGHT);
    $objPHPExcel->getActiveSheet()->getCell('H' . $H)->setValue("$" . number_format($total, 0, ',', '.'));
