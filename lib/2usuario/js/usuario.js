    ...
    if (id_perfil_usuario == '') {
        ...
        if ($("#tr_ingeniero_asig" + id_perfil_usuario).val() == null)
        {
            cadena = '<tr id="tr_ingeniero_asig' + id_perfil_usuario + '">' +
                    '<td><button type="button" name="btn_eliminar_ing_' + id_perfil_usuario + '" id="btn_eliminar_ing_' + id_perfil_usuario + '" class="btn btn-danger btn-xs" onclick="delMoreIngeniero(' + id_perfil_usuario + ');contadorFilasTablaGeneral(' + concat + 'ingenieroAddTR' + concat + ',' + concat + 'txt_add_ingeniero' + concat + ');"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>Eliminar</button></td>' +
                    '<td>' + text_ingeniero +
    ...
    if (id_perfil_usuario == '') {
        ...
        if ($("#tr_encargado_asig" + id_perfil_usuario).val() == null)
        {
            cadena = '<tr id="tr_encargado_asig' + id_perfil_usuario + '">' +
                    ...
                    '" id="btn_eliminar_enc_' + id_perfil_usuario + '" class="btn btn-danger btn-xs" onclick="delMoreEncargado(' + id_perfil_usuario + ');contadorFilasTablaGeneral(' + 
