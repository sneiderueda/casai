...
<form id="frm_CreateCumplimentacion" class="form-horizontal">                   
    <fieldset class="letraBl">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">                
                <input type="text" class="form-control data" id="txtDescargo" name="txtDescargo" placeholder="Descripcion descargo" required="true" readonly="on">                
            </div>
        </div>
        <!-- Tipo de descargo-->
        <div class="form-group">
            ...
            <div class="col-sm-5">                
                <select id="sltipoDescargo" readonly="on" disabled="on" name="sltipoDescargo" class="form-control data" required="true"
     ...
     <div class="form-group">
                ...
                <div class="col-sm-5">                
                    <select id="slSubestacion" readonly="on" disabled="on" name="slSubestacion" class="form-control"  required="true" onchange="AddSubestacion(this.value);">
                    </select>                
                </div>
         </div>
        <div class="form-group">
            ...
            <div class="col-sm-5 input-group date" id='PresInicio' style="width:200px" >                
                <input type='text' id="txtDateInicio" readonly="on" disabled="on" name="txtDateInicio" class="form-control" readonly />
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5 input-group date" id='PresFinal' style="width:200px" >                
                <input type='text' id="txtDateFinal" readonly="on" disabled="on" name="txtDateFinal" class="form-control" readonly />
                <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>                    
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">  
                <select class="form-control" readonly="on" disabled="on" id="slc_jornada" name="slc_jornada" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">                
                <select id="slGestor" readonly="on" disabled="on" name="slGestor" class="form-control data" required="true">
                </select>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5" id="txt_ingenieros">             
        ...
        <div class="form-group" id="btn_saveActBaremo">
            <div class="col-sm-offset-4 col-sm-4">
                <button type="button" name="btnAddAcDescargo" id="btnAddAcDescargo" class="btn btn-primary fondo" onclick="editCumplimentacion();"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span> Guardar</button>
            </div>
        </div>
    </div>
</fieldset>
