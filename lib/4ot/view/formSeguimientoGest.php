...
<html lang="en">
    ...
    <button name="btnList" id="btnList" class="btn btn-default" type="button" onclick="gritGestionAct()">Mostrar listado</button>
    </br>
    </br>
    <fieldset>
        ...
        <form id="frm_DataSeguimientoOT" class="form-horizontal">    
            ...
            <legend>Detalle de la Actividad</legend>
            ...
            <legend>Seguimiento de la Actividad</legend>
            <div id="Seg_data">
