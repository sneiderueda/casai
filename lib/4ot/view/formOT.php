...
<html lang="en">
    ...
    <button name="btnListPres" id="btnListPres" class="btn fondo letraN" type="button" onclick="gritPresupuestoOT()">Mostrar listado</button>
    </br>
    </br>
                    ...
                    <div class="col-md-12 ">
                        <div role="tabpanel" class="">
                            <ul class="nav nav-tabs borde_inf" role="tablist" id="agregar_tab">
                                <li role="presentation" id="tab0" class="active"><a href="#seccion0" aria-controls="seccion0" data-toggle="tab" role="tab">Datos Ot aprobada</a></li>
                                <li role="presentation" id="tab1" class=""><a href="#seccion1" aria-controls="seccion1" data-toggle="tab" role="tab">Programar Labores</a></li>
                            </ul>
                        ...
                        <div class="tab-content" id="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="seccion0">
                                ...
                                <legend class="titulo">Orden de Trabajo y Cronograma</legend>  
