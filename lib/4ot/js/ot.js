...
function DivProgramarOT(prusupuesto_id) {
    ...
    $("#programar_OT").dialog({
        ...
        create: function (event) {
            $(event.target).parent().css({top: 650, left: 320});
        },
        buttons: {
            "Cerrar": function ()
            {
...
function JsonPresupuesto(presupuesto_id) {
...
function AddSoporteSeguimiento() {
    ...
    var elimine = '<button type="button" name="btn_eliminar_doc" id="btn_eliminar_doc" class="btn btn-default btn-xs" onclick="eliminardoc(' + inicial + ')"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>Eliminar</button>';
...
function AddSoporteSeguimientoModificado() {
    ...
    var elimine = '<button type="button" name="btn_eliminar_doc_js" id="btn_eliminar_doc_js" class="btn btn-default btn-xs" onclick="eliminardoc(' + inicial + ')"><span class="glyphicon glyphicon-remove-circle" aria-hidden="true"></span>Eliminar</button>';
    var content = "<tr id='tr_" + inicial + "'><td>" + elimine + "</td><td>" + input + "</td></tr>";
