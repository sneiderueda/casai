...
/////////////////////////////////
//CARGAR ACTIVIDADES RESUELTAS //
/////////////////////////////////
function cargarResueltaActividad() 
{
     $.ajax({
        type: "POST",
        url: 'lib/4ot/controlador/CT_ot.php',
        async: false,
        data: {
            opcion: 'cargarResueltaActividad'
        },
        success: function (retu) {
            $("#contenido").html(retu);
        }
...
/////////////////////////////////////////
//CARGAR HISTORIAL LABORES POR USUARIO //
/////////////////////////////////////////
function cargarActividadesHistorial() 
{
    $.ajax({
        type: "POST",
        url: 'lib/4ot/controlador/CT_ot.php',
        async: false,
        data: {
            opcion: 'cargarActividadesHistorial'
        },
        success: function (retu) {
            $("#contenido").html(retu);
        }
