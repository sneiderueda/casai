...
function SavePresupuesto() {
    ...
    var txt_gestorCodensa = $("#txt_gestorCodensa").val();
    ...
    if (txt_gestorCodensa == "") {
        alert("Por favor ingrese el nombre del Gestor de CODENSA");
        return false;
    }
...
function JsonDetallePresupuesto(detallepresupuesto_id, control) {
    ...
    if (control == '1') {
        ...
        $("#txt_gestorCodensa").val(jsondata.detallepresupuesto_codensagestor);
